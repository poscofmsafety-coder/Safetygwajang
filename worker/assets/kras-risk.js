(function(){
  ...
  function sheetRows(){
    ...
    const guide=[['KRAS 등록 호환 안내'],['본 파일은 KRAS 일반 위험성평가 화면의 입력 흐름에 맞춘 등록 보조·복사·증빙 첨부용 작업파일입니다.'],['KRAS 사용설명서에서는 일반 3단계/체크리스트/OPS/빈도강도 평가의 Excel 일괄 직접 업로드 기능을 명시적으로 확인할 수 없으므로 직접 업로드 호환을 보장하지 않습니다.'],['화학물질 위험성평가에는 KRAS 공식 Excel 일괄 업로드 기능이 별도로 안내되어 있으므로 화학물질 평가는 KRAS가 제공하는 공식 양식을 사용하세요.'],['등록 권장 순서'],['1. KRAS에서 위험성평가 생성 → 평가방법과 구분 선택'],['2. 사전준비의 공정(작업) 및 유해인자 등록'],['3. 유해·위험요인과 현재 안전보건조치 입력'],['4. 위험성 결정 → 허용 불가능 항목의 감소대책 입력'],['5. 담당자·완료일 확인 후 잔여위험 재평가'],['6. 결과 공유·TBM 실시 및 기록·보존'],['공식사이트','https://portal.kosha.or.kr/kras/implement/real']];
